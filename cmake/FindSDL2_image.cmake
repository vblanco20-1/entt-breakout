...
set(SDL2_IMAGE_LIBPATH "${SDL2IMAGEDIR}/lib/x86/")

list(APPEND SDL2_IMAGE_DLLS "${SDL2_IMAGE_LIBPATH}/SDL2_image.dll")
list(APPEND SDL2_IMAGE_DLLS "${SDL2_IMAGE_LIBPATH}/libjpeg-9.dll")
list(APPEND SDL2_IMAGE_DLLS "${SDL2_IMAGE_LIBPATH}/libpng16-16.dll")
list(APPEND SDL2_IMAGE_DLLS "${SDL2_IMAGE_LIBPATH}/libtiff-5.dll")
list(APPEND SDL2_IMAGE_DLLS "${SDL2_IMAGE_LIBPATH}/libwebp-7.dll")
list(APPEND SDL2_IMAGE_DLLS "${SDL2_IMAGE_LIBPATH}/zlib1.dll")
#set(SDL2_IMAGE_DLLS "${SDL2IMAGEDIR}/lib/x86/SDL2_image.dll")
#set(SDL2_IMAGE_DLLS "${SDL2IMAGEDIR}/lib/x64/SDL2_image.dll")
