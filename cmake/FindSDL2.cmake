...
if(WIN32)
    # Search for SDL2 Debug CMake build in extern/SDL2-2.0.8-dev/build
    find_path(SDL2_PATH "include/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../extern/SDL2-2.0.8-dev" NO_DEFAULT_PATH)
    if(SDL2_PATH)
        if (EXISTS "${SDL2_PATH}/build/Debug/SDL2.lib")
            set(SDL2_INCLUDE_DIRS "${SDL2_PATH}/include")
            set(SDL2_LIBS "${SDL2_PATH}/build/Debug/SDL2.lib")
            set(SDL2_DLLS "${SDL2_PATH}/build/Debug/SDL2.dll")
            if(_SDL2_use_main)
                list(APPEND SDL2_LIBS "${SDL2_PATH}/build/Debug/SDL2main.lib")
            endif()
        endif()
    endif()
    if(NOT SDL2_FOUND)
        # Search for SDL2 in extern/SDL2-2.0.8
        find_path(SDL2_PATH "include/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../extern/SDL2-2.0.8" NO_DEFAULT_PATH)
        if(SDL2_PATH)
            set(SDL2_INCLUDE_DIRS "${SDL2_PATH}/include")
            if("${CMAKE_GENERATOR}" MATCHES "Win64")
                set(SDL2_LIBS "${SDL2_PATH}/lib/x64/SDL2.lib")
                set(SDL2_DLLS "${SDL2_PATH}/lib/x64/SDL2.dll")
                if(_SDL2_use_main)
                    list(APPEND SDL2_LIBS "${SDL2_PATH}/lib/x64/SDL2main.lib")
                endif()
            else()
                set(SDL2_LIBS "${SDL2_PATH}/lib/x86/SDL2.lib")
                set(SDL2_DLLS "${SDL2_PATH}/lib/x86/SDL2.dll")
                if(_SDL2_use_main)
                    list(APPEND SDL2_LIBS "${SDL2_PATH}/lib/x86/SDL2main.lib")
                endif()
            endif()
        endif()
    endif()
